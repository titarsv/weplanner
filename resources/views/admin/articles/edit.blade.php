            ...
            <div class="panel-group">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <input type="text" data-translit="input" class="form-control" name="title" value="{!! old('title', $article->title) !!}" />
                                    @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <textarea id="text-area" name="text" class="form-control" rows="6">{!! old('text', $article->text) !!}</textarea>
                                    @if($errors->has('text'))
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <input type="hidden" id="image" name="image_id" value="{!! old('image_id', $article->image_id) !!}" />
                                    <div id="image-output" class="category-image">
                                        <img src="/assets/images/{!! old('href', $article->image->href) !!}" />
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <textarea name="meta_description" class="form-control" rows="6">{!! old('meta_description', $article->meta_description) !!}</textarea>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <textarea name="meta_keywords" class="form-control" rows="6">{!! old('meta_keywords', $article->meta_keywords)!!}</textarea>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <input type="text" data-translit="output" class="form-control" name="url_alias" value="{!! old('url_alias', $article->url_alias) !!}" />
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="row">
                                <label class="col-sm-2 text-right">Перечень товаров</label>
                                <div class="col-sm-10 text-left">
                                    <select data-placeholder="Выберите товары" name="products[]" class="form-control chosen-select" multiple="multiple">
                                        @foreach($products as $prod)
                                            <option value="{!! $prod->id !!}"
                                                    @if (in_array($prod->id, (array)old('products')))
                                                    selected
                                                    @elseif (in_array($prod->id, $products_ids))
                                                    selected
                                                    @endif
                                            >{!! $prod->name !!}</option>
                                        @endforeach
