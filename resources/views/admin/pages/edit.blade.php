                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <input type="text" data-translit="input" class="form-control" name="name" value="{!! old('name', $content->name) !!}" />
                                    @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <textarea id="text-area" name="content" class="form-control" rows="6">{!! old('content', $content->content) !!}</textarea>
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <input type="text" class="form-control" name="meta_title" value="{!! old('meta_title', $content->meta_title) !!}" />
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <textarea name="meta_description" class="form-control" rows="6">{!! old('meta_description', $content->meta_description) !!}</textarea>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <textarea name="meta_keywords" class="form-control" rows="6">{!! old('meta_keywords', $content->meta_keywords) !!}</textarea>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <input type="text" data-translit="output" class="form-control" name="url_alias" value="{!! old('url_alias', $content->url_alias) !!}" />
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <input type="text" class="form-control" name="sort_order" value="{!! old('sort_order', $content->sort_order) !!}" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-10 col-sm-push-2 text-left">
                                    ...
                                    <a href="/admin/pages" class="btn btn-primary">Назад</a>
                                </div>
                            </div>
                        </div>
                    </div>
