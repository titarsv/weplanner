            ...
            <div class="panel-group">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <input type="text" data-translit="input" class="form-control" name="name" value="{!! old('name', $product->name) !!}" />
                                    @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-4">
                                    <input type="hidden" id="image" name="image_id" value="{!! old('image_id', $product->image_id) !!}" />
                                    <div id="image-output" class="category-image">
                                        <img src="/assets/images/{!! old('href', $product->image->href) !!}" />
                                             ...
                                             @foreach($product->gallery_images() as $image)
                                                 <div class="col-sm-3">
                                                     <div>
                                                         ...
                                                         <img src="{{ $image->get_current_file_url('product_gallery') }}">
                                                     </div>
                                                 </div>
                                             @endforeach
                                         @endif
                        ...
                        <div class="form-group">
                            <div class="row">
                                <label class="col-sm-2 text-right control-label">Текущая цена</label>
                                <div class="form-element col-sm-10">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <input type="text" class="form-control" name="old_price" value="{!! old('old_price', $product->old_price) !!}" />
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <input type="text" class="form-control" name="catalog_id" value="{!! old('catalog_id') ? old('catalog_id') : $product->catalog_id!!}" />
                        ...
                        <div class="form-group">
                            <div class="row">
                                <label class="col-sm-2 text-right">Количество на складе</label>
                                <div class="form-element col-sm-10">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <select data-placeholder="Выберите узлы" name="units[]" id="units_select" class="form-control chosen-select" multiple="multiple" data-product-id="{{ $product->id }}">
                                        @foreach($units as $unit)
                                            <option value="{!! $unit->id !!}"
                                                    @if (in_array($unit->id, (array)old('units')))
                                                    selected
                                                    @elseif (in_array($unit->id, $added_units))
                                                    selected
                                                    @endif
                            ...
                            <div class="row" id="schemes">
                                @include('admin.layouts.schemes', ['schemes' => $schemes, 'schemes_positions' => $schemes_positions])
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        @foreach($products as $prod)
                                            @if($prod->id != $product->id)
                                                <option value="{!! $prod->id !!}"
                                                        @if (in_array($prod->id, (array)old('analogs')))
                                                        selected
                                                        @elseif (in_array($prod->id, $analogs_ids))
                                                        selected
                                                        @endif
                                                >{!! $prod->name !!}</option>
                                            @endif
