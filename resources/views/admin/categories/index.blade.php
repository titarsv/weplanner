    ...
    <div class="content-title">
        <div class="row">
            ...
            <div class="col-sm-2 text-right">
                <a href="/admin/categories/create" class="btn">Добавить</a>
            </div>
        </div>
    </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody class="category-table">
                        @if(!$categories->isEmpty())
                            @include('admin.layouts.category', ['categories' => $categories, 'child' => 1])
                        @else
                            <tr>
                                <td colspan="6" class="colspan">Нет добавленных категорий!</td>
                            </tr>
                        @endif
                    </tbody>
                </table>
